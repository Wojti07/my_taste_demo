...
var _viewsAddPrivateRecipeViewJs = require('./views/addPrivateRecipeView.js');
var _viewsAddPrivateRecipeViewJsDefault = _parcelHelpers.interopDefault(_viewsAddPrivateRecipeViewJs);
...
const controlRecipes = async function (url, id) {
  try {
    // Loading spinner
    _viewsRecipeViewJsDefault.default.spinner();
    // Loading recipe
    await _modelJs.loadRecipe(url, id);
    // Rendering recipe
    _viewsRecipeViewJsDefault.default.render(_modelJs.state.recipe);
  } catch (err) {
    _viewsRecipeViewJsDefault.default.error();
    console.error(err);
  }
};
const controlSearchResults = async function () {
  try {
    // Loading spinner
    _viewsResultViewJsDefault.default.spinner();
    // Search recipes
    const query = _viewsSearchViewJsDefault.default.getQuery();
    if (!query) return;
    // Loading recipes
    await _modelJs.loadSearchReultas(query);
    // Rendering recipes
    _viewsResultViewJsDefault.default.render(_modelJs.state.search.results);
  } catch (err) {
    console.log(err);
  }
};
const controlAddBookmark = function () {
  // Add/remove bookmark
  if (!_modelJs.state.recipe.bookmarked) _modelJs.addBookmark(_modelJs.state.recipe); else _modelJs.deletBookmark(_modelJs.state.recipe);
  // Update recipe view
...
const controlAddRecipe = function (newRecipe) {
  try {
    ...
    _modelJs.addPrivateRecipe(newRecipe);
    // Render bookmark view
    _viewsBookmarksViewJsDefault.default.render(_modelJs.state.bookmarks);
    // Close form window
    setTimeout(function () {
      _viewsAddPrivateRecipeViewJsDefault.default.toggleWindow();
    }, 1000);
  } catch (err) {
    console.error(err);
...
const init = function () {
  ...
  _viewsResultViewJsDefault.default.addHandlerResult(controlRecipes);
  _viewsSearchViewJsDefault.default.addHandlerSearch(controlSearchResults);
  _viewsRecipeViewJsDefault.default.addHadlerAddBookmark(controlAddBookmark);
  _viewsBookmarksViewJsDefault.default.addHandlerBookmarkRecipeRender(controlRecipes);
  _viewsAddPrivateRecipeViewJsDefault.default.addHandlerAddPrivateRecipe(controlAddRecipe);
};
init();

},{"./model.js":"1hp6y","./views/recipeView.js":"9e6b9","./views/searchView.js":"3rYQ6","./views/resultView.js":"2blfJ","./views/bookmarksView.js":"2EbNZ","./views/addPrivateRecipeView.js":"2pU2m","core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1hp6y":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
_parcelHelpers.export(exports, "loadSearchReultas", function () {
  return loadSearchReultas;
});
_parcelHelpers.export(exports, "addBookmark", function () {
  return addBookmark;
});
_parcelHelpers.export(exports, "deletBookmark", function () {
  return deletBookmark;
});
_parcelHelpers.export(exports, "clearBookmarks", function () {
  return clearBookmarks;
});
_parcelHelpers.export(exports, "addPrivateRecipe", function () {
  return addPrivateRecipe;
});
...
const loadRecipe = async function (url, id) {
  try {
    if (url) {
    ...
    if (state.bookmarks.some(book => book.id == state.recipe.id)) state.recipe.bookmarked = true; else state.recipe.bookmarked = false;
...
const loadSearchReultas = async function (query) {
  try {
    state.search.query = query;
    const data = await _helperJs.AJAX(`${_configJs.API_URL}&q=${query}`);
...
const deletBookmark = function (recipe) {
  // Dellet bookmark
...
const addPrivateRecipe = function (newRecipe) {
...
async function loadRecipeFromUrl(url) {
  const {recipe} = await _helperJs.AJAX(url);
  return {
    id: recipe.uri,
    title: recipe.label,
    image: recipe.image,
...
},{"regenerator-runtime":"62Qib","./config.js":"6pr2F","./helper.js":"dSCNX","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"62Qib":[function(require,module,exports) {
/**
...
_parcelHelpers.export(exports, "timeoutSec", function () {
  return timeoutSec;
});
_parcelHelpers.export(exports, "cloesSec", function () {
  return cloesSec;
});
const APP_ID = '64bb7720';
const APP_KEY = "b311a156acda35e5c4848ca55d8fae8d";
const API_URL = `https://api.edamam.com/api/recipes/v2?type=public&app_id=${APP_ID}&app_key=${APP_KEY}`;
const timeoutSec = 10;
const cloesSec = 2;
...
const AJAX = async function (url) {
  try {
    const resposne = await Promise.race([fetch(url), timeout(_configJs.timeoutSec)]);
...
class RecipeView extends _ViewJsDefault.default {
  ...
  _massageError = 'We could not find that recipe. Please try another one.';
  _massege = '';
  ...
  _generateMarkup() {
    return `
      ...
      <div class="recipe__details">
        ...
        <div class="recipe__user-generated ${this._data.key ? true : 'hidden'}">
          <svg>
      ...
      <div class="recipe__directions">
        ...
        <p class="recipe__directions-text">
          This recipe was carefully designed and tested by Please check out
...
},{"./View.js":"48jhP","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"2EbNZ":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _ViewJs = require("./View.js");
var _ViewJsDefault = _parcelHelpers.interopDefault(_ViewJs);
    ...
    return `
        <li class="preview">
            <a class="preview__link" href="#" data-url="${result.selfLink || ""}" data-id="${result.id}" >
                ...
                <div class="preview__user-generated ${result.key ? true : 'hidden'}">
                    <svg>
                    <use href="${_urlImgIconsSvgDefault.default}#icon-user"></use>
                    </svg>
                  </div>
...
},{"./View.js":"48jhP","url:../../img/icons.svg":"3t5dV","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"2pU2m":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _ViewJs = require("./View.js");
var _ViewJsDefault = _parcelHelpers.interopDefault(_ViewJs);
class AddPrivateRecipeView extends _ViewJsDefault.default {
...
exports.default = new AddPrivateRecipeView();
...
},{"../internals/export":"7f5VM"}]},["1WnDs","3miIZ"], "3miIZ", "parcelRequire4769")
